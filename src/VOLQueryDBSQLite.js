...
export class VOLQueryDBSQLite {
    ...
    constructor ( db ) {
        ...
        this.db                 = db || new sqlite3 ( env.SQLITE_FILE );
        ...
        ( async () => {
            ...
            await this.consensusService.initializeWithNodeURLAsync ( env.VOL_PRIMARY_URL );
    ...
    async ingestLoopAsync () {
        ...
        for ( let row = statement.get (); row; row = statement.get ()) {
            ...
            console.log ( 'INGEST:', height );

            const affirmOffer = ( offerID ) => {
            ...
            const closeOffer = ( offerID, closed ) => {
            ...
            for ( let transaction of blockBody.transactions ) {
                ...
                switch ( txBody.type ) {
                    ...
                    case 'BUY_ASSETS': {
                        ...
                        console.log ( txBody.type );
                        closeOffer ( txBody.offerID, 'COMPLETED' );
                        break;
                    }
                    ...
                    case 'CANCEL_OFFER': {
                        ...
                        closeOffer ( offer.offerID, 'CANCELLED' );
                        break;
                    }
                    ...
                    case 'OFFER_ASSETS': {
                        ...
                        console.log ( '  SELLER:', seller.index );
                        offer.seller = seller.index;

                        affirmKnownOffer ( offer );
                        console.log ( offer );

                        // console.log ( '  OFFER_ASSETS:' );
                        // for ( let assetID of txBody.assetIdentifiers ) {
            ...
            this.db.prepare ( `UPDATE blocks SET ingested = TRUE WHERE height = ?` ).run ( height );
        }
